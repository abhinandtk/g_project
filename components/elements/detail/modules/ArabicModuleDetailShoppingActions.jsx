...
const ArabicModuleDetailShoppingActions = ({
    product,
    extended = false,
    language
}) => {
    ...
    const handleShowCompareView = (e) => {
        ...
        if (productIdForCompare.indexOf(prVarientId) === -1) {
            if (productIdForCompare.length > 3) {
            ...
            productStock !== 0 && (
                <div
                    ...
                    <figure style={{ maxWidth: '150px' }}>
                        <figcaption>{labels['Quantity']}</figcaption>
...
export default ArabicModuleDetailShoppingActions;
