...
const RecentlyViewedProducts = ({ collectionSlug, boxed, layout }) => {
                ...
                carouselView = (
                    <Slider
                        ...
                        {productItems.map((item, index) => {
                            if (index < 8) {
                                return <Product product={item} key={item.id} hideThumbnails={true}/>;
                            }
                        })}
                    </Slider>
                );
...
export default connect((state) => state.collection)(RecentlyViewedProducts);
