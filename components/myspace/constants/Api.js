...
const apis = {
    ...
    'serviceRequests':`${constants.port}/API/service-requests`,
    'sellRequests':`${constants.port}/API/sell-requests`,
    'contactUsRequests':`${constants.port}/API/contactus-requests`,
    ...
    'termsCondition':`${constants.port}/API/get_terms_conditions`,
    'returnPolicy':`${constants.port}/API/get_return_policy_data`,

    'campaignCustomers':`${constants.port}/API/campaign-customers`,
   
    'collectionPoints':`${constants.port}/API/collection-points`,
